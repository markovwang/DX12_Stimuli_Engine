...
struct MeshGeometry
{
    ...
    D3D12_VERTEX_BUFFER_VIEW GetVPosBufferView() const
    {
        ...
        vPosBufferView.StrideInBytes = VertexByteStride;
    ...
    D3D12_VERTEX_BUFFER_VIEW GetVColorBufferView() const
    {
        ...
        vColorBufferView.BufferLocation = VertexBufferGPU->GetGPUVirtualAddress();
        vColorBufferView.SizeInBytes = vColorBufferByteSize;
        vColorBufferView.StrideInBytes = VertexByteStride;
